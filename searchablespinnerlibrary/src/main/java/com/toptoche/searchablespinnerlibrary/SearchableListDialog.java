...
public class SearchableListDialog extends DialogFragment implements
    ...
    private static final String ITEMS = "Fincas";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (null != savedInstanceState) {
            _searchableItem = (SearchableItem) savedInstanceState.getSerializable("Fincas");
        }
        // Change End
        ...
        String strTitle = _strTitle == null ? "Selecciona la Finca" : _strTitle;
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putSerializable("Finca", _searchableItem);
